        ...
        <div className="bg-white border border-accent/15 py-8 px-4 shadow-premium sm:rounded-2xl sm:px-10">
          {success ? (
            ...
            >
              ...
              <h2 className="text-xl font-bold text-primary">Registration Successful!</h2>
            ...
            <>
              <div className="mb-6 text-center">
                ...
                <p className="text-secondary text-xs mt-1">Get started with your visa consultancy profile</p>
              </div>
              ...
              <form className="space-y-5" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    />
                    <User className="absolute left-3.5 top-3 h-4 w-4 text-secondary/60" />
                  </div>
                </div>
